...
public class CommentController{
    ...
    @PostMapping
    public Result createComment(@Parameter(description = "评论信息") @RequestBody @Valid Comment comment)
    {
        // 创建新评论
    ...
    public Result restoreComment(@Parameter(description = "评论ID") @PathVariable Long id)
    {
        // 恢复已删除评论
