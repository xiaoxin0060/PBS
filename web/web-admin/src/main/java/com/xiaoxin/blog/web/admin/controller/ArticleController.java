...
public class ArticleController{
            ...
            UpdateArticleVo updateArticleVo) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException
    {
        ...
        updateWrapper
                .set(updateArticleVo.getTitle() != null, Article::getTitle, updateArticleVo.getTitle())
                .set(updateArticleVo.getContent() != null, Article::getContent, updateArticleVo.getContent())
                .set(updateArticleVo.getCategoryId() != null, Article::getCategoryId, updateArticleVo.getCategoryId())
            ...
            @Parameter(description = "每页条数") @RequestParam(defaultValue = "10") Integer pageSize)
    {
        ...
        List<DraftArticleVo> articleVos = result
                .getRecords()
                .stream()
                .map(article -> new DraftArticleVo(article.getId(), article.getTitle(), article.getUserId(), article.getCoverImage()))
